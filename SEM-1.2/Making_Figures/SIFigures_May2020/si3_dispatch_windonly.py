...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 10 13:16:08 2020
...
pickle_in = open('/Users/jacquelinedowling/MEM_Nov2019/SEM-1.2/Output_Data/Oct29_combos/Oct29_combos_Wind_PGPbatt.pickle', 'rb')
...
y1 = np.vstack([wind_source1, pgp_source1, batt_source1 ])
pal1 = ['blue', 'pink','purple']
labels1 = ["Wind", "LDS", "Battery" ]
...
plt.savefig('si/SI_dispatch_windonly.pdf', bbox_inches='tight')
plt.show()