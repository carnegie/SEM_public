...
##===========================================
#Figure 3, Simple Combos with Nuclear
##===========================================
##===========================================
#Import stuff
##===========================================
...
def get_cost_contributions(base):
    ...
    nuc_t = (np.multiply(inputs["FIXED_COST_NUCLEAR"], results["CAPACITY_NUCLEAR"]) +
             np.multiply(inputs["VAR_COST_NUCLEAR"], results["DISPATCH_NUCLEAR"]) )
...
#    print(calc_sys_cost)
    return wind_m, solar_m , pgp_m, batt_m, nuc_m
##======================================================================================================
...
pickle_in = open('/Users/jacquelinedowling/MEM_Nov2019/SEM-1.2/Output_Data/Oct29_combos_nuc/Oct29_combos_nuc_SolarWind_PGPbatt.pickle', 'rb')
...
#    pickle_in = open("/Users/jacquelinedowling/SEM-1.1/Output_Data/PGPtest5_simplecombos_fixed/PGPtest5_simplecombos_fixed_" + case + ".pickle","rb")
    pickle_in = open('/Users/jacquelinedowling/MEM_Nov2019/SEM-1.2/Output_Data/Oct29_combos_nuc/Oct29_combos_nuc_' + case + '.pickle', 'rb')
    print(case)
    base = pickle.load(pickle_in)
    info = base[0]
    inputs = base[1]
...
data = (nuc_costs, wind_costs, solar_costs,  batt_costs, pgp_costs) 
newdata = []
...
p1 = plt.bar(ind, dataset1, width, color='red')
p2 = plt.bar(ind, dataset2, width, bottom=dataset1, color='blue')
p3 = plt.bar(ind, dataset3, width, bottom=dataset1+dataset2, color='orange')
...
plt.legend((p1[0], p2[0], p3[0], p4[0], p5[0] ), ('Nuclear', 'Wind', 'Solar', 'Battery','LDS' ),loc='upper center', bbox_to_anchor=(1.15, 1.03))
...
fig.text(.25, 0.80, 'Nuclear+Solar', size='small', ha = 'center')
fig.text(.51, 0.80, 'Nuclear+Wind', size='small',ha = 'center')
fig.text(.68, 0.80, 'Nuclear+Wind+Solar', size='small')


plt.savefig('si/SI_combos_nuc.pdf', bbox_inches='tight')
