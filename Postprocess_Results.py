...
def get_dimension_info(case_dic_list):
    ...
    FIXED_COST_WIND = []
    FIXED_COST_NUCLEAR = []
    FIXED_COST_FUEL_ELECTROLYZER = []
    FIXED_COST_FUEL_CHEM_PLANT = []
    ...
    VAR_COST_WIND = []
    VAR_COST_NUCLEAR = []
    VAR_COST_FUEL_ELECTROLYZER = []
    VAR_COST_FUEL_CHEM_PLANT = []
    VAR_COST_FUEL_CO2 = []
    DECAY_RATE_STORAGE = []
    ...
    for idx in range(num_scenarios):
        ...
        FIXED_COST_FUEL_ELECTROLYZER = np.r_[FIXED_COST_FUEL_ELECTROLYZER, case_dic_list[idx]['FIXED_COST_FUEL_ELECTROLYZER']]
        FIXED_COST_FUEL_CHEM_PLANT = np.r_[FIXED_COST_FUEL_CHEM_PLANT, case_dic_list[idx]['FIXED_COST_FUEL_CHEM_PLANT']]
        FIXED_COST_FUEL_H2_STORAGE = np.r_[FIXED_COST_FUEL_H2_STORAGE, case_dic_list[idx]['FIXED_COST_FUEL_H2_STORAGE']]
        ...
        VAR_COST_FUEL_ELECTROLYZER = np.r_[VAR_COST_FUEL_ELECTROLYZER, case_dic_list[idx]['VAR_COST_FUEL_ELECTROLYZER']]
        VAR_COST_FUEL_CHEM_PLANT = np.r_[VAR_COST_FUEL_CHEM_PLANT, case_dic_list[idx]['VAR_COST_FUEL_CHEM_PLANT']]
        VAR_COST_FUEL_CO2 = np.r_[VAR_COST_FUEL_CO2, case_dic_list[idx]['VAR_COST_FUEL_CO2']]
    ...
    FIXED_COST_FUEL_ELECTROLYZER_list = np.unique(FIXED_COST_FUEL_ELECTROLYZER)
    FIXED_COST_FUEL_CHEM_PLANT_list = np.unique(FIXED_COST_FUEL_CHEM_PLANT)
    FIXED_COST_FUEL_H2_STORAGE_list = np.unique(FIXED_COST_FUEL_H2_STORAGE)
    ...
    VAR_COST_FUEL_ELECTROLYZER_list = np.unique(VAR_COST_FUEL_ELECTROLYZER)
    VAR_COST_FUEL_CHEM_PLANT_list = np.unique(VAR_COST_FUEL_CHEM_PLANT)
    VAR_COST_FUEL_CO2_list = np.unique(VAR_COST_FUEL_CO2)
    ...
    cost_list = {'FIXED_COST_NATGAS':FIXED_COST_NATGAS_list,
                 ...
                 'FIXED_COST_FUEL_ELECTROLYZER':FIXED_COST_FUEL_ELECTROLYZER_list,
                 'FIXED_COST_FUEL_CHEM_PLANT':FIXED_COST_FUEL_CHEM_PLANT_list,
                 'FIXED_COST_FUEL_H2_STORAGE':FIXED_COST_FUEL_H2_STORAGE_list,
                 ...
                 'VAR_COST_FUEL_ELECTROLYZER':VAR_COST_FUEL_ELECTROLYZER_list,
                 'VAR_COST_FUEL_CHEM_PLANT':VAR_COST_FUEL_CHEM_PLANT_list,
                 'VAR_COST_FUEL_CO2':VAR_COST_FUEL_CO2_list,
...
def prepare_scalar_variables (global_dic, case_dic_list, result_list ):
    ...
    for idx in range(num_scenarios):
        ...
        tmp['FIXED_COST_FUEL_ELECTROLYZER'] = np.array(np.squeeze(case_dic_list[idx]['FIXED_COST_FUEL_ELECTROLYZER']))
        tmp['FIXED_COST_FUEL_CHEM_PLANT'] = np.array(np.squeeze(case_dic_list[idx]['FIXED_COST_FUEL_CHEM_PLANT']))
        tmp['FIXED_COST_FUEL_H2_STORAGE'] = np.array(np.squeeze(case_dic_list[idx]['FIXED_COST_FUEL_H2_STORAGE']))
        ...
        tmp['VAR_COST_FUEL_ELECTROLYZER']       = np.array(np.squeeze(case_dic_list[idx]['VAR_COST_FUEL_ELECTROLYZER']))
        tmp['VAR_COST_FUEL_CHEM_PLANT']       = np.array(np.squeeze(case_dic_list[idx]['VAR_COST_FUEL_CHEM_PLANT']))
        tmp['VAR_COST_FUEL_CO2']       = np.array(np.squeeze(case_dic_list[idx]['VAR_COST_FUEL_CO2']))
        ...
        tmp['CAPACITY_FUEL_ELECTROLYZER'] = np.array(np.squeeze(result_list[idx]['CAPACITY_FUEL_ELECTROLYZER']))
        tmp['CAPACITY_FUEL_CHEM_PLANT'] = np.array(np.squeeze(result_list[idx]['CAPACITY_FUEL_CHEM_PLANT']))
        tmp['CAPACITY_FUEL_H2_STORAGE'] = np.array(np.squeeze(result_list[idx]['CAPACITY_FUEL_H2_STORAGE']))
        ...
        tmp['DISPATCH_TO_FUEL_H2_STORAGE']       = np.array(np.squeeze(result_list[idx]['DISPATCH_TO_FUEL_H2_STORAGE']))      #/ num_time_periods
        tmp['DISPATCH_FROM_FUEL_H2_STORAGE']       = np.array(np.squeeze(result_list[idx]['DISPATCH_FROM_FUEL_H2_STORAGE']))      #/ num_time_periods
        tmp['FUEL_H2_STORAGE']       = np.array(np.squeeze(result_list[idx]['FUEL_H2_STORAGE']))      #/ num_time_periods
...
def stack_plot1(
    ...
    CAPACITY_FUEL_ELECTROLYZER  = get_multicases_results(res, num_case , 'CAPACITY_FUEL_ELECTROLYZER')
    CAPACITY_FUEL_CHEM_PLANT  = get_multicases_results(res, num_case , 'CAPACITY_FUEL_CHEM_PLANT')
    CAPACITY_FUEL_H2_STORAGE  = get_multicases_results(res, num_case , 'CAPACITY_FUEL_H2_STORAGE')
    ...
    FIXED_COST_FUEL_ELECTROLYZER = get_multicases_results(res, num_case, 'FIXED_COST_FUEL_ELECTROLYZER')
    FIXED_COST_FUEL_CHEM_PLANT = get_multicases_results(res, num_case, 'FIXED_COST_FUEL_CHEM_PLANT')
    FIXED_COST_FUEL_H2_STORAGE = get_multicases_results(res, num_case, 'FIXED_COST_FUEL_H2_STORAGE')
    ...
    VAR_COST_FUEL_ELECTROLYZER = get_multicases_results(res, num_case, 'VAR_COST_FUEL_ELECTROLYZER')
    VAR_COST_FUEL_CHEM_PLANT = get_multicases_results(res, num_case, 'VAR_COST_FUEL_CHEM_PLANT')
    VAR_COST_FUEL_CO2 = get_multicases_results(res, num_case, 'VAR_COST_FUEL_CO2')
    ...
    DISPATCH_TO_FUEL_H2_STORAGE      = get_multicases_results(res, num_case, 'DISPATCH_TO_FUEL_H2_STORAGE')       / num_time_periods
    DISPATCH_FROM_FUEL_H2_STORAGE      = get_multicases_results(res, num_case, 'DISPATCH_FROM_FUEL_H2_STORAGE')       / num_time_periods
    FUEL_H2_STORAGE      = get_multicases_results(res, num_case, 'FUEL_H2_STORAGE')       / num_time_periods
    ...
    yaxis_capacity_po = np.vstack([CAPACITY_NATGAS[order_list], 
                                   ...
                                   CAPACITY_FUEL_ELECTROLYZER[order_list],
                                   ]) #CAPACITY_STORAGE[order_list]
    labels_capacity = ["natgas", "solar", "wind", "nuclear", 'fuel', "storage"]
    colors_capacity = [color_natgas[1], color_solar[1], color_wind[1], color_nuclear[1], color_fuel[1], color_storage[1]]
    info_capacity = {
            "title": "Capacity mix\n(kW)",
    ...
    dispatch_tot_fuel = np.sum(DISPATCH_TO_FUEL_H2_STORAGE,axis=1)
    ...
    yaxis_dispatch_po = np.vstack([dispatch_tot_natgas[order_list], 
                                   ...
                                   dispatch_tot_fuel[order_list]])
    battery_charge = np.array([dispatch_tot_to_storage, dispatch_tot_from_storage])
    
    labels_dispatch = ["natgas", "solar", "wind", "nuclear", "fuel"]
    colors_dispatch = [color_natgas[1], color_solar[1], color_wind[1], color_nuclear[1], color_fuel[1]]    
    info_dispatch = {
    ...
    cost_fuel = cal_cost(FIXED_COST_FUEL_ELECTROLYZER, CAPACITY_FUEL_ELECTROLYZER, VAR_COST_FUEL_ELECTROLYZER, DISPATCH_TO_FUEL_H2_STORAGE, num_case, num_time_periods)
    ...
    yaxis_cost1_po = np.vstack([cost_natgas[2][order_list], 
                                ...
                                cost_fuel[2][order_list],
                                cost_storage[2][order_list]])
    labels_cost1 = ["natgas", "solar", "wind", "nuclear", "fuel", "storage"]
    colors_cost1 = [color_natgas[1], color_solar[1], color_wind[1], color_nuclear[1], color_fuel[1], color_storage[1]]
    info_cost1 = {
            "title": "System cost\n($/h/kW)",
            "xlabel": var_dimension_list[0],
    ...
    yaxis_cost2_po = np.vstack([cost_natgas[0][order_list],
                                ...
                                cost_fuel[0][order_list],
                                cost_fuel[1][order_list],
...
def stack_plot2(
    ...
    CAPACITY_FUEL_ELECTROLYZER  = get_multicases_results(res, num_case , 'CAPACITY_FUEL_ELECTROLYZER')[case_idx]
    ...
    DISPATCH_TO_FUEL_H2_STORAGE_yr = get_multicases_results(res, num_case,      'DISPATCH_TO_FUEL_H2_STORAGE',     1,num_time_periods,24,1)[case_idx]  
    ...
    DISPATCH_TO_FUEL_H2_STORAGE_week1 = get_multicases_results(res, num_case,      'DISPATCH_TO_FUEL_H2_STORAGE',     week1start,week1start+num_periods_week-1,num_periods_week,2)[case_idx]  
    ...
    DISPATCH_TO_FUEL_H2_STORAGE_week2 = get_multicases_results(res, num_case,      'DISPATCH_TO_FUEL_H2_STORAGE',     week2start,week2start+num_periods_week-1,num_periods_week,2)[case_idx]  
    ...
    yaxis_yr_po = np.vstack([DISPATCH_NATGAS_yr,
                             ...
                             DISPATCH_WIND_yr,
                             DISPATCH_NUCLEAR_yr,
                             DISPATCH_TO_FUEL_H2_STORAGE_yr,
                             DISPATCH_FROM_STORAGE_yr
                             ]) 
    
    labels = ["natgas", "solar", "wind", "nuclear","dispatch"]
    colors = [color_natgas[1], color_solar[1], color_wind[1], color_nuclear[1], color_fuel[1], color_storage[1]]    
    info_yr = {
    ...
    yaxis_week1_po = np.vstack([DISPATCH_NATGAS_week1,
                               ...
                               DISPATCH_TO_FUEL_H2_STORAGE_week1,
    ...
    yaxis_week2_po = np.vstack([DISPATCH_NATGAS_week2,
                               ...
                               DISPATCH_TO_FUEL_H2_STORAGE_week2,
